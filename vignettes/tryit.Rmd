...
simply do `HINF5300::runExamples("assignment1")`. A pop up window will ask you
to type the path to your data and set the parameters for step detection as described in the
